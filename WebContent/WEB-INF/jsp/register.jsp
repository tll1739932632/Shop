					...
					<form id="registerForm"  method="post" novalidate="novalidate">
						<table>
							...
							<tr>
								...
								<td>
									...
									<tr>
										...
										<td>
												<input type="date" name="birthday" class="text" onfocus="WdatePicker();">
										</td>
									</tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											...
											<img id="captchaImage" class="captchaImage" src="./getYZM.do" title="点击更换验证码">
											<span></span>
										</span>
									</td>
								</tr>
							<tr>
								...
								<td>
									<input id="btnSubmit" type="button" class="submit" value="同意以下协议并注册">
								</td>
							</tr>
							<tr>
								<th>&nbsp;
